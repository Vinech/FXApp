...
- (void)viewDidLoad
{
    ...
    imageview_asy.center=CGPointMake(100, 170);
    NSLog(@"url====%@",[imageview_asy urlString]);
   imageview_ziji=[[UIImageView alloc]init];
    imageview_ziji.frame=CGRectMake(50, 145,220, 150);
    imageview_ziji.backgroundColor=[UIColor clearColor];
    imageview_ziji.image=[imageview_asy image];
    
    contentLabel = [[UILabel alloc] initWithFrame:CGRectMake(5,0,310,140)];
    ...
    //来源
    sourceLabel = [[UILabel alloc] initWithFrame:CGRectMake(5,420,310,30)];
    ...
    dateLabel = [[UILabel alloc] initWithFrame:CGRectMake(5,460,310,30)];
    dateLabel.numberOfLines = 1;
    dateLabel.text = @"08-15月-2012 16:26:45";
...
- (BOOL)shouldAutorotateToInterfaceOrientation:(UIInterfaceOrientation)interfaceOrientation
{
    if (interfaceOrientation==UIInterfaceOrientationLandscapeLeft) { 
        ...
        contentLabel.frame=CGRectMake(0,0,480,150);
        //zuo 
    } 
    ...
    if (interfaceOrientation==UIInterfaceOrientationPortrait) { 
        ...
        contentLabel.frame=CGRectMake(0,0,320,150);
