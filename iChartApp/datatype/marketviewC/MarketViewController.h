...
#import "data.h"
@interface MarketViewController : UIViewController<UITableViewDelegate,UITableViewDataSource,GCDAsyncSocketDelegate,UIScrollViewDelegate,UIActionSheetDelegate>{
