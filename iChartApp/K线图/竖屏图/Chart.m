...
- (void)initChart{
    ...
    //背景填充颜色
    //    CGContextSetRGBFillColor(context, 53/255.0f, 54/255.0f, 50/255.0f, 1.0); 
	...
	for(int i=0;i<self.sections.count;i++){
		...
		for(int s=0;s<sec.series.count;s++){
			...
			for(int j=0;j<label.count;j++){
                ...
                if (sec.frame.origin.x+sec.paddingLeft+2+w<sec.frame.size.width+20 || sec.frame.origin.y>=120 ) {
                    ...
                    if (w-sec.frame.origin.x-sec.paddingLeft-sec.paddingLeft-sec.frame.origin.x<=-104) {
                        ...
                        [text drawAtPoint:CGPointMake(w-sec.frame.origin.x-sec.paddingLeft-sec.paddingLeft-sec.frame.origin.x,sec.frame.origin.y-5) withFont:[UIFont systemFontOfSize: 10]];
...
-(void)drawYAxis{
	...
	for(int secIndex=0;secIndex<self.sections.count;secIndex++){
		...
		for(int aIndex=0;aIndex<sec.yAxises.count;aIndex++){
			...
			NSString *format=[@"%." stringByAppendingFormat:@"%df",5];
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
        ...
        button.frame = CGRectMake(17, 2, 30, 30);
        ...
        UIView * view = [[UIView alloc] initWithFrame:CGRectMake(0, 230, 10, 10)];
...
- (void)choose
{
    ...
    if (isE == 1) {
        ...
        [button setBackgroundImage:[UIImage imageNamed:@"toolBtn.png"] forState:UIControlStateNormal];
        
        UIImageView *backgroundView =[[UIImageView alloc] initWithFrame:CGRectMake(1, 35, 120, 120)];
...
- (void)buttonTap:(UIButton *)sender
{
    ...
    switch (sender.tag) {
        case 100:
        {
            ...
            seleted1 = 0;
            if (seleted==0) {//如果选择了就不能重复点击
                seleted++;
                yesBtn1 = [UIButton buttonWithType:UIButtonTypeCustom];
                yesBtn1.frame = CGRectMake(210, 240, 30,30);
                yesBtn1.tag = 1002;
                ...
                noBtn1.frame = CGRectMake(270, 240, 30, 30);
                noBtn1.tag = 1003;
                ...
                pick1 = [[UIPickerView alloc] initWithFrame:CGRectMake(0, 240,320,150)];
                pick1.dataSource = self;
                pick1.delegate = self;
                pick1.tag =20;
                [pick1 selectRow:3 inComponent:0 animated:YES];
                ...
                yesBtn1.frame = CGRectMake(210, 50, 30, 30);
                noBtn1.frame  = CGRectMake(270, 50, 30, 30);
                pick1.frame   = CGRectMake(0, 80, 320, 160);
                
                pick.frame    = CGRectMake(0, 240, 320, 160);
                yesBtn.frame  = CGRectMake(230, 240, 30, 30);
                noBtn.frame   = CGRectMake(270, 240, 30, 30);
        ...
        case 101:
        {
            ...
            if (seleted1 == 0) {
                ...
                yesBtn.frame = CGRectMake(210, 240, 30, 30);
                ...
                pick = [[UIPickerView alloc] initWithFrame:CGRectMake(0, 240,320,150)];
                ...
                [UIView beginAnimations:nil context:nil];
                [UIView setAnimationDuration:.2f];
                yesBtn.frame  = CGRectMake(210, 50, 30, 30);
                noBtn.frame   = CGRectMake(270, 50, 30, 30);
                pick.frame    = CGRectMake(0, 80, 320, 160);
                
                yesBtn1.frame = CGRectMake(230, 240, 30, 30);
                noBtn1.frame  = CGRectMake(270, 240, 30, 30);
                pick1.frame   = CGRectMake(0, 240, 320, 160);
                [UIView commitAnimations];
...
- (void)reBtn:(UIButton *)sender
{
    ...
    yesBtn1.frame  = CGRectMake(230, 240, 30, 30);
    noBtn1.frame   = CGRectMake(270, 240, 30, 30);
    pick.frame     = CGRectMake(0, 240, 320, 162);
    pick1.frame    = CGRectMake(0, 240, 320, 162);
    ...
    switch (sender.tag) {
        case 1000:
        {
            ...
            switch (charts) {
                ...
                case 4:
                {
                    model = [[BarChartModel  alloc] init];
                    [self addModel:model withName:@"candle"];
        ...
        {
            NSLog(@"123");
            //            if (delegate!=nil && [delegate performSelector:@selector(timerTitle:)]) {
            
            [self.delegate timerTitle:self.timeTitle];
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component
{
    if (pickerView.tag ==20) {
        timeTitle = [[arrayTitle objectAtIndex:row] intValue];
        NSLog(@"timmeTitle = %d",timeTitle);
